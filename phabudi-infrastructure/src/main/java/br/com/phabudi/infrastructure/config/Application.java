package br.com.phabudi.infrastructure.config;
...
@Configuration
@ComponentScan(basePackages = {"br.com.phabudi", "gumga.framework"})
@EnableJpaRepositories(repositoryFactoryBeanClass = GumgaRepositoryFactoryBean.class, basePackages = {"br.com.phabudi", "gumga.framework"})
...
//        config.addDataSourceProperty("url", "jdbc:mysql://localhost:3306/phabudi?zeroDateTimeBehavior=convertToNull");
...
//        config.addDataSourceProperty("password", "senha");
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(DataSource dataSource) {
        ...
        factory.setPackagesToScan("gumga.framework.domain","br.com.phabudi");
